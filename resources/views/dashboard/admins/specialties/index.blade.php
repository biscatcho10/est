            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">All Specialties</h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            <div class="dropdown dropdown-inline">
                                {{-- Add New --}}
                                <a href=" {{route('admin.specialties.create')}} " class="btn btn-brand btn-icon-sm" ><i class="flaticon2-plus"></i> Add New</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <thead class="kt-datatable__head">
                                <tr class="kt-datatable__row" style="left: 0px">
                                    ...
                                    <th data-field="OrderID" class="kt-datatable__cell kt-datatable__cell--sort">
                                        <span style="width: 110px">Specialty Name</span>
                                    </th>
                                    ...
                                    <tr data-row="0" class="kt-datatable__row" style="left: 0px">
                                        ...
                                        <td data-field="Actions" data-autohide-disabled="false" class="kt-datatable__cell">
                                            <span style="
                                                    ...
                                                    width: 110px;
                                                ">
                                                <a href="{{route('admin.specialties.edit',$specialty->id)}}" class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                    title="Edit details">
                                                    <i class="la la-cog"></i>
                                                </a>
